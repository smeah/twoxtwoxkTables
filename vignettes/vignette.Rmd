...
## NOTE: YOU MAY NEED TO INSTALL THESE PACKAGES TO BUILD THE VIGNETTE
## THEY ARE NOT AUTOMATICALLY SUGGESTED BY THE PACKAGE
## AS THEY ARE ONLY USED FOR THE VIGNETTE
...
all.equal(as.numeric(mantelhaen.test(partial_tables, correct = FALSE)$statistic), 
          as.numeric(mantelhaenzel.test(partial_tables)$chi.sq.stat), tolerance = 0.01)
